...
const buttonVariants = cva(
  ...
  "transition-all duration-200 ease-spring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:ring-offset-1 " +
  ...
  "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-card shadow-soft-sm hover:bg-secondary/60 hover:border-slate-300",
        secondary:
