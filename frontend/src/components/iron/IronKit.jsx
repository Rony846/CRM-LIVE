...
export const IRON_ADMIN_NAV = [
  ...
  ['Inventory', [['Master SKUs', '/admin/master-sku'], ['Firms', '/admin/firms'], ['Serial Numbers', '/inventory/serial-numbers'], ['Build Unit', '/production/build'], ['Stabilizer Scan-in', '/inventory/stabilizer-scan'], ['Stock Reports', '/admin/reports'], ['Product Datasheets', '/admin/product-datasheets']]],
