...
export const IRON_GATE_NAV = [['Workspace', [['Ship Desk', '/ship-desk'], ['Return Desk', '/return-desk'], ['RTO / Returns', '/rto-returns'], ['Inventory Inward', '/inventory/inward'], ['Dashboard', '/gate'], ['Scan Parcel', '/gate/scan'], ['Gate Logs', '/gate/logs'], ['Scheduled', '/gate/scheduled'], ['Dispatch Queue', '/view/dispatch-queue'], ['My Attendance', '/my-attendance']]]];
