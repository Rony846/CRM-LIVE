...
export default function BatteryDatasheet({ data }) {
  ...
  return (
    <div className="bg-white min-h-auto w-full mx-auto font-sans relative" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="bg-gradient-to-r from-green-600 via-emerald-500 to-green-600 text-white p-3 md:p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            <p className="text-[8px] md:text-[10px] text-green-100 uppercase tracking-wider">Product Datasheet</p>
            <p className="text-xs md:text-sm font-semibold">LiFePO4 Battery Series</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-3 md:p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <p className="text-green-400 text-[10px] md:text-xs font-semibold mb-1 uppercase tracking-wider">
          ...
          <div className="w-20 h-16 md:w-32 md:h-24 bg-gray-700/50 rounded-xl flex items-center justify-center overflow-hidden ml-2 md:ml-4 flex-shrink-0">
            {data.image_url ? (
              ...
              <Battery className="w-10 h-10 md:w-14 md:h-14 text-green-400" />
            )}
          </div>
        </div>
      </div>
      ...
      <div className="p-2 md:p-4">
        ...
        {features.length > 0 && (
          <div className="mt-2 md:mt-3">
            <h3 className="text-[10px] md:text-xs font-bold text-gray-900 mb-1 md:mb-2 pb-1 border-b-2 border-green-500 uppercase tracking-wider">
              Key Features
            </h3>
        ...
        {/* Safety Notice */}
        <div className="mt-2 md:mt-3 p-1.5 md:p-2 bg-green-50 border border-green-200 rounded">
          <p className="text-[8px] md:text-[9px] text-green-800 font-medium">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-1 md:gap-2 text-[8px] md:text-[10px]">
          <div className="flex flex-wrap justify-center md:justify-start items-center gap-2 md:gap-3">
            <div className="flex items-center gap-0.5 md:gap-1">
              <Phone className="w-2.5 h-2.5 md:w-3 md:h-3 text-green-400" />
              <span>+91 9999036254</span>
            </div>
            <div className="flex items-center gap-0.5 md:gap-1">
              <Mail className="w-2.5 h-2.5 md:w-3 md:h-3 text-green-400" />
              <span>service@musclegrid.in</span>
            </div>
            <div className="flex items-center gap-0.5 md:gap-1">
              <Globe className="w-2.5 h-2.5 md:w-3 md:h-3 text-green-400" />
