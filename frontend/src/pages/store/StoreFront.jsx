...
import { API } from '@/App';
import { ShoppingCart, Search, ChevronLeft, Plus, Minus, Trash2, Loader2, ShieldCheck, Truck, BadgeCheck, X } from 'lucide-react';
    ...
    <div className="mgs" style={{ minHeight: '100vh', background: PAPER, fontFamily: F, color: INK,
      ...
      {loading ? (
        ...
        <div style={{ maxWidth: 560, margin: '0 auto', padding: '60px 20px', textAlign: 'center' }}>
          ...
          <button className="mgs-btn" onClick={() => { setView('catalog'); goTop(); }} style={{ marginTop: 24, border: 'none', background: O, color: '#fff', borderRadius: 10, padding: '12px 28px', cursor: 'pointer', fontFamily: FH, fontWeight: 700, fontSize: 14 }}>Continue Shopping</button>
        </div>
      ) : null}
