...
(function(){
  ...
  MG.mountChrome=function(){
    ...
    foot.innerHTML='<div style="max-width:1320px;margin:0 auto;display:grid;grid-template-columns:1.8fr 1fr 1fr 1fr;gap:32px" class="mg-foot-grid">'
      ...
      +'<div><div style="font-weight:700;margin-bottom:8px">Shop</div>'+lk('/store/products/','All products')+lk('/store/products/?category=Inverter','Solar inverters')+lk('/store/products/?category=Battery','Lithium batteries')+lk('/store/products/?category=Stabilizer','Stabilizers')+'</div>'
