...
const MODULES = [
  ...
  { label: 'Gate Scan', desc: 'Inward / outward scanning', icon: 'qr_code_scanner', to: '/home', ready: false },
  { label: 'Supervisor Portal', desc: 'Escalations & actions', icon: 'supervisor_account', to: '/home', ready: false },
];
